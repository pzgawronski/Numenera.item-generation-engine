...
raw_folder = "./RAW_ITEMS"

raw_artifacts = f"{raw_folder}/RAW_ITEMS_ARTIFACTS.csv"
raw_cyphers = f"{raw_folder}//RAW_ITEMS_CYPHERS.csv"
raw_oddities = f"{raw_folder}//RAW_ITEMS_ODDITIES.csv"
